...
export function Card({
  ...
  const classes = v({
    ...
    variants: {
      elevated: "border border-white/60 dark:border-white/10 bg-[rgb(var(--surface)/0.7)] shadow-[0_10px_30px_rgba(2,8,23,0.08)]",
      outline: "border border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/50",
      ghost: "border border-transparent bg-white/40 dark:bg-slate-900/30",
    },
    variant, className,
  });
